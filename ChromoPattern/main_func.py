...
from ChromoPattern.keyCNA import cell_events
from ChromoPattern.events_define import define_CNA_mechnism
from ChromoPattern.estimateDER import estimate_der
from ChromoPattern.tree_class import TreeClass
...
def chromosome_event(node_data,
    ...
    if verbose:
        ...
        print(f'\t *Detail in : https://github.com/FangWang-SYSU/ChromoPattern')
        print(f'Finished!')