...
setuptools.setup(
    ...
    url="https://github.com/FangWang-SYSU/ChromoPattern.git",
    ...
    ext_modules=cythonize("ChromoPattern/fast_score.pyx"),#ext_modules,
    ...
    entry_points={
        "console_scripts": [
            "ChromoPattern=ChromoPattern.cli_main:main",
        ],
    },
)
